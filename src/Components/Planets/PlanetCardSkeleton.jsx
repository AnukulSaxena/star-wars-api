...
const PlanetCardSkeleton = () => {
  return (
    <div
      role="status"
      className="w-80 h-80 p-4 border border-neutral-400 rounded shadow animate-pulse md:p-6 dark:border-neutral-700"
    >
      <div className="flex items-center justify-center h-24 mb-4 bg-neutral-500 rounded dark:bg-neutral-700"></div>
