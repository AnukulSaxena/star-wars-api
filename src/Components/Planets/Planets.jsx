...
const Pagination = ({setPlanetsData}) => {
    ...
    return (
        <div className='w-full p-2 h-12 flex justify-center items-center'>
            ...
            <button className=' flex items-center hover:dark:fill-neutral-900 fill-neutral-500 dark:hover:bg-neutral-400 rounded-l-md border-r-0 border dark:border-neutral-900' onClick={handlePrevious}>
            ...
            <button className=' dark:hover:bg-neutral-400 flex items-center rounded-r-md  border-l-0 hover:dark:fill-neutral-900 fill-neutral-500 border dark:border-neutral-900' onClick={handleNext}>
                <svg viewBox="0 0 24 24" className='h-10 w-10' xmlns="http://www.w3.org/2000/svg">
